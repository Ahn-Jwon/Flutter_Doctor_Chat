...
import 'package:team3_flutter_project_self_diagnosis_app/widget/calendarUtil.dart';
...
setList() {
  kEventSource={};
      ...
      DateTime dt = DateTime.parse(rsList[i]["insertdate"]);
      String rs = "";
      ...
      kEventSource[dt] = [
        ...
        Event(cg, rs, dt,rsList[i]["category"],rsList[i]["result"]) 
      ];
